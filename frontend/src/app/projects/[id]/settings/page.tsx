    ...
    <div className="max-w-2xl mx-auto px-4 py-8 space-y-8">
      ...
      <form onSubmit={handleSave} className="space-y-6">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm space-y-5">
          <h2 className="text-base font-semibold text-gray-900">Basic Configuration</h2>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm space-y-5">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
              ...
              <span className="text-gray-400 font-normal ml-1">(one regex per line — only matching URLs will be crawled)</span>
            </label>
            <textarea
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
              ...
              <span className="text-gray-400 font-normal ml-1">(one regex per line — matching URLs will be skipped)</span>
            </label>
            <textarea
